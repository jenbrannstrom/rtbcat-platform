...
- `QA-002` (Phase 1/2 slice): root `make v1-conversion-regression` target now runs conversion/readiness smoke regression (readiness scoring + ingestion service + provider fixtures + canary helper coverage).
