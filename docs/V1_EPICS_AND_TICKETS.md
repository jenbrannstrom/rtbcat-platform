...
- `E4-005` started (operator visibility slice): the same SLO panel now renders a latest-sample API latency table (highest-latency endpoints first) for direct bottleneck triage.
