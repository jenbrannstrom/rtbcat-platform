  ...
  const { data, isLoading, error } = useQuery<ConfigPerformanceResponse>({
    ...
    queryFn: async () => {
      const params = new URLSearchParams({
        billing_csv_path: '/home/jen/Documents/rtbcat-platform/creative-intelligence/docs/cat-scan-Billingid-reached.csv',
        bids_csv_path: '/home/jen/Documents/rtbcat-platform/creative-intelligence/docs/cat-scan-criD-bids-reached.csv',
      });
      const res = await fetch(`http://localhost:8000/analytics/rtb-funnel/configs?${params}`);
