...
CATSCAN_CANARY_MAX_HOME_ENDPOINT_EFFICIENCY_LATENCY_MS=\${CATSCAN_CANARY_MAX_HOME_ENDPOINT_EFFICIENCY_LATENCY_MS:-30000} \
CATSCAN_CANARY_BIDSTREAM_DIMENSION_WAIVER_JSON=\${CATSCAN_CANARY_BIDSTREAM_DIMENSION_WAIVER_JSON:-} \
