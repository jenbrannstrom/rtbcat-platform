...
class GeoMismatchResponse(BaseModel):
    ...
    plaintext_language_summary: Optional[str] = None
    primary_text_language: Optional[str] = None
    primary_text_language_code: Optional[str] = None
    secondary_text_language: Optional[str] = None
    secondary_text_language_code: Optional[str] = None
    secondary_text_sample: Optional[str] = None
...
async def get_creative_geo_mismatch(
    ...
    if mismatch["alert"]:
        return GeoMismatchResponse(
            ...
            plaintext_language_summary=mismatch.get("plaintext_language_summary"),
            primary_text_language=mismatch.get("primary_text_language"),
            primary_text_language_code=mismatch.get("primary_text_language_code"),
            secondary_text_language=mismatch.get("secondary_text_language"),
            secondary_text_language_code=mismatch.get("secondary_text_language_code"),
            secondary_text_sample=mismatch.get("secondary_text_sample"),
