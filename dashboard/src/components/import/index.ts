 ...
 *
 * Extracted from app/import/page.tsx to reduce file size:
 * - ExportInstructions.tsx: Google Authorized Buyers export guide (~240 lines)
 * - RequiredColumnsTable.tsx: Required columns info (~25 lines)
 * - TroubleshootingSection.tsx: Large file troubleshooting (~40 lines)
...
export { RequiredColumnsTable } from "./RequiredColumnsTable";
