...
export interface Translations {
  ...
  pretargeting: {
    ...
    endpointsEditQps: string;
    endpointsDiscardAll: string;
    endpointsPushToGoogle: string;
    endpointsConfirmTitle: string;
    endpointsConfirmBody: string;
    endpointsCommitting: string;
    endpointsPartialFailure: string;
    endpointsSuccess: string;
    endpointsCurrentTotal: string;
    endpointsAfterTotal: string;
    endpointsChangesPending: string;
    endpointsConfirm: string;
    endpointsCancel: string;
    endpointsRefresh: string;
    endpointsUndo: string;
  ...
  import: {
    ...
    columnsDetectedAndMapped: string;
    ...
    daysAgoShort: string;
    duplicatesSkippedCount: string;
    requiredColumnTitle: string;
    optionalColumnTitle: string;
    missingRequiredColumnTitle: string;
    missingOptionalColumns: string;
    dataFreshness: string;
    coveragePercent: string;
    lastDaysDataQuestion: string;
    dayCount: string;
    loadingFreshnessData: string;
    noDataFreshnessInformation: string;
    dataPresent: string;
    noData: string;
    cellsCount: string;
    csvTypeQuality: string;
    csvTypePerformance: string;
    csvTypeGeo: string;
    ...
    exportGuideDimDay: string;
    exportGuideDimCountry: string;
    exportGuideDimCreativeId: string;
    exportGuideDimBuyerAccountId: string;
    exportGuideDimPretargetingConfigBillingId: string;
    exportGuideDimCreativeSize: string;
    exportGuideDimCreativeFormat: string;
    exportGuideDimHour: string;
    exportGuideDimPublisherId: string;
    exportGuideDimPublisherName: string;
    exportGuideDimBidFilteringReason: string;
    exportGuideMetricBidsInAuction: string;
    exportGuideMetricAuctionsWon: string;
    exportGuideMetricBids: string;
    exportGuideMetricReachedQueries: string;
    exportGuideMetricImpressions: string;
    exportGuideMetricSpendBuyerCurrency: string;
    exportGuideMetricActiveViewViewable: string;
    exportGuideMetricActiveViewMeasurable: string;
    exportGuideMetricBidRequests: string;
    exportGuideMetricInventoryMatches: string;
    exportGuideMetricSuccessfulResponses: string;
    exportGuideMetricClicks: string;
  ...
  creatives: {
    ...
    langLabel: string;
    staleCache: string;
    languageFlagsNav: string;
    languageFlagsTitle: string;
    languageFlagsDescription: string;
    languageFlagsAtRisk30d: string;
    languageFlagsRiskFigure: string;
    languageFlagsConfirmedWrong: string;
    languageFlagsNeedsReview: string;
    languageFlagsOk: string;
    languageFlagsSeverityConfirmed: string;
    languageFlagsSeverityReview: string;
    languageFlagsSeverityOk: string;
    languageFlagsHeadlineConfirmed: string;
    languageFlagsHeadlineReview: string;
    languageFlagsHeadlineOk: string;
    languageFlagsHeadlineFallback: string;
    languageFlagsCountryMore: string;
    languageFlagsCurrencyNote: string;
    ...
    languageFlagsLangRed: string;
    languageFlagsLangOrange: string;
    languageFlagsGeoRed: string;
    languageFlagsFlagged: string;
    languageFlagsSearchLabel: string;
    languageFlagsSearchPlaceholder: string;
    languageFlagsLanguageStatus: string;
    languageFlagsGeoStatus: string;
    languageFlagsAllLanguageResults: string;
    languageFlagsLanguageRed: string;
    languageFlagsLanguageOrange: string;
    languageFlagsLanguageGreen: string;
    languageFlagsAllGeoResults: string;
    languageFlagsGeoRedOption: string;
    languageFlagsGeoOrangeOption: string;
    languageFlagsGeoGreenOption: string;
    languageFlagsRefreshAll: string;
    languageFlagsRefreshHint: string;
    languageFlagsRefreshQueuedSuffix: string;
    languageFlagsRefreshQueuedMessage: string;
    languageFlagsRefreshNoMatchMessage: string;
    languageFlagsRefreshFailed: string;
    languageFlagsTableLangMismatch: string;
    languageFlagsTableGeoLinguistic: string;
    languageFlagsTableServing: string;
    languageFlagsTableSpend30d: string;
    languageFlagsSourceUnknown: string;
    languageFlagsCurrencyLabel: string;
    languageFlagsUpdated: string;
    languageFlagsNoAiRefreshYet: string;
    languageFlagsNoResults: string;
    languageFlagsShowingOf: string;
    statusGreen: string;
    statusOrange: string;
    statusRed: string;
  };
  ...
  recommendations: {
    ...
    typeGeoExclusion: string;
    typePublisherBlock: string;
    typeConfigInefficiency: string;
    typeCreativePause: string;
    typeCreativeReview: string;
    typeFraudAlert: string;
    actionTypeBlock: string;
    actionTypeExclude: string;
    actionTypeAdd: string;
    actionTypeRemove: string;
    actionTypeMonitor: string;
    actionTypeReview: string;
    targetTypeSize: string;
    targetTypeGeo: string;
    targetTypePublisher: string;
    targetTypeConfig: string;
    targetTypeApp: string;
    impactWastedLabel: string;
    impactPotentialSavings: string;
    hideDetails: string;
    showDetailsAndActions: string;
    ...
    thresholdOf: string;
    recommendedActionsSectionTitle: string;
    ...
    markResolved: string;
    dismiss: string;
    noCompatiblePretargetingActions: string;
    stagedPendingChangesForBilling: string;
    failedToStagePendingChanges: string;
    failedToLoadRecommendations: string;
    configFallbackName: string;
    recommendationsCountLabel: string;
    severityCountCritical: string;
    severityCountHigh: string;
    severityCountMedium: string;
    severityCountLow: string;
    totalSpendAnalyzed: string;
    reanalyze: string;
    noIssuesDetectedTitle: string;
  ...
  wasteAnalysis: {
    ...
    noSizeDataAvailable: string;
    wasteReportNoTrafficData: string;
    wasteReportNoTrafficDataDesc: string;
    wasteReportAvgQps: string;
    wasteReportWasteRate: string;
    wasteReportWasteRequestsOfTotal: string;
    wasteReportPotentialSavings: string;
    wasteReportPotentialSavingsPerMonth: string;
    wasteReportDailyAverageBasis: string;
    wasteReportSizeGaps: string;
    wasteReportSizesWithNoCreatives: string;
    wasteReportAnalysisPeriod: string;
    wasteReportRecommendationsSummary: string;
    wasteReportAddCreative: string;
  ...
  previewModal: {
    ...
    urlLabelGooglePlayStore: string;
    urlLabelAppleAppStore: string;
    urlLabelAppsFlyer: string;
    urlLabelAdjust: string;
    urlLabelBranch: string;
    urlLabelKochava: string;
    urlLabelDoubleClickTracker: string;
    urlLabelTrackingPixel: string;
    urlLabelLandingPage: string;
    urlTooltipStoreInstallDestination: string;
    urlTooltipAttributionPlatform: string;
    urlTooltipDoubleClickTracker: string;
    urlTooltipTrackingPixel: string;
    urlTooltipLandingPage: string;
    ...
    langMismatchTitle: string;
    marketCurrencyTitle: string;
    detectedLabel: string;
    heuristicCue: string;
    heuristicLabel: string;
    checkingMarketSignals: string;
    langMismatchLabel: string;
    geoLinguisticLabel: string;
    primaryLanguageConfidence: string;
    dominantLanguageConfidenceHelp: string;
    geoLinguisticAnalysisTitle: string;
    geoLinguisticAnalysisDescription: string;
    geoLinguisticLoading: string;
    geoLinguisticFailedToLoad: string;
    geoLinguisticAnalysisFailed: string;
    geoLinguisticRisk: string;
    geoLinguisticLanguages: string;
    geoLinguisticCurrencies: string;
    geoLinguisticServing: string;
    geoLinguisticCharsAnalyzed: string;
    geoLinguisticOcrExtractions: string;
    geoLinguisticVideoFrames: string;
    geoLinguisticHtmlScreenshot: string;
    geoLinguisticReanalyze: string;
    geoLinguisticRetry: string;
    geoLinguisticRetryLoad: string;
    geoLinguisticRunAnalysis: string;
    geoLinguisticNoReportYet: string;
    severityHigh: string;
    severityMedium: string;
    severityLow: string;
