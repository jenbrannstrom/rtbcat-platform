...
help:
	...
	@echo "Closeout env: CATSCAN_CLOSEOUT_RUN_DEPLOYED=1 (also run deployed canaries), CATSCAN_CLOSEOUT_ALLOW_DEPLOYED_BLOCKED=1 (treat exit 2 as blocked), CATSCAN_CLOSEOUT_REPORT_PATH=/tmp/v1_closeout_last_run.md"
