...
完整的多语言用户手册托管于 **[docs.rtb.cat](https://docs.rtb.cat)**。

**[技术说明（Explainers）](https://docs.rtb.cat/zh/explainers/)** 板块是运营真实 Google Authorized Buyers 席位的第一手操作知识——简短、原子化、可直接引用：

- [2026 年 Google Authorized Buyers 仍需五份独立的 CSV 报告](https://docs.rtb.cat/zh/explainers/five-csv-reports/)
- [AB 席位的 QPS 漏斗](https://docs.rtb.cat/zh/explainers/qps-funnel/)
- [预定向配置——10 个配置的现实](https://docs.rtb.cat/zh/explainers/pretargeting-configs/)
- [安全的预定向更改 + 回滚](https://docs.rtb.cat/zh/explainers/safe-pretargeting-changes/)
- [按发布商/地理/尺寸分析 QPS 浪费](https://docs.rtb.cat/zh/explainers/qps-waste-analysis/)
- [素材聚类与点击宏审计](https://docs.rtb.cat/zh/explainers/creative-clustering-click-macros/)
- [小型机构如何获得并运营 AB 席位](https://docs.rtb.cat/zh/explainers/agencies-obtain-ab-seats/)
- [Cat-Scan 不做什么](https://docs.rtb.cat/zh/explainers/what-cat-scan-does-not-do/)
- [出价过滤——第五份报告](https://docs.rtb.cat/zh/explainers/bid-filtering-report/)
- [自带模型优化器（BYOM）](https://docs.rtb.cat/zh/explainers/byom-optimizer/)

本平台仓库 `main` 分支的每次推送都会自动刷新文档站点的时效性（通过向 `rtbcat/rtbcat-docs` 发送 `repository_dispatch` 事件），因此已发布的页面始终带有最新的平台提交 SHA 和最新的 `lastmod`。
